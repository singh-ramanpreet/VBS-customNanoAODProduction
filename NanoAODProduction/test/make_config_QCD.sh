...
cmsDriver.py nano_production_mc_qcd_2016 -s NANO --mc --eventcontent NANOAODSIM --datatier NANOAODSIM --no_exec --conditions 102X_mcRun2_asymptotic_v8 --era  Run2_2016,run2_nanoAOD_94X2016 \
-n 10 \
...
cmsDriver.py nano_production_mc_qcd_2017 -s NANO --mc --eventcontent NANOAODSIM --datatier NANOAODSIM --no_exec --conditions 102X_mc2017_realistic_v8 --era Run2_2017,run2_nanoAOD_94XMiniAODv2 \
-n 10 \
...
cmsDriver.py nano_production_mc_qcd_2018 -s NANO --mc --eventcontent NANOAODSIM --datatier NANOAODSIM --no_exec --conditions 102X_upgrade2018_realistic_v21 --era Run2_2018,run2_nanoAOD_102Xv1 \
-n 10 \
